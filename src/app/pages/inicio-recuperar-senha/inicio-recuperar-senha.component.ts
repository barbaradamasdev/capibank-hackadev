...
@Component({
    ...
    imports: [CabecalhoLoginComponent, RodapeLoginComponent, FormularioRecuperarCodigoComponent, FormularioCriarSucessoComponent, CriarContaLinkComponent, EsqueciSenhaLoginComponent, FormularioCriarNomeComponent, FormularioRecuperarCriarNovaSenhaComponent, FormularioRecuperarPgUmComponent]
})
